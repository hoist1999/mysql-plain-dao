...
exports.generateAndWriteDaos = generateAndWriteDaos;
...
async function generateDao(db, table, schema, options) {
    ...
    if (daoDir === modelDir) {
        ...
        const relativePath = path_1.default.relative(daoDir, modelDir);
...
async function generateAndWriteDaos(db, tables, schema, options) {
    if (options.generateType === 'dao' || options.generateType === 'all') {
        for (const table of tables) {
            ...
            const formattedOutput = await (0, generateModel_1.formatTypeScript)(daoContent);
