...
exports.BaseDaoDoubleID = void 0;
const mysql2_1 = require("mysql2");
const BaseDaoUUID_1 = require("./BaseDaoUUID");
const DbUtil_1 = require("../database/DbUtil");
/** DAO class for tables with both UUID and auto-increment ID */
class BaseDaoDoubleID extends BaseDaoUUID_1.BaseDaoUUID {
    id_field;
    constructor(option) {
        super(option);
    ...
    async getIdFromUUIDAsync(uuid) {
        ...
        let para = [uuid];
        const id = await DbUtil_1.DbUtil.executeGetNumberAsync(sql, para);
        return id;
    }
    /**
    ...
    async getUUIDFromIdAsync(id) {
        ...
        let para = [id];
        const uuid = await DbUtil_1.DbUtil.executeGetStringAsync(sql, para);
        return uuid;
    }
}
exports.BaseDaoDoubleID = BaseDaoDoubleID;
