...
describe('CLI Generator Tests', () => {
    ...
    it('should generate only dao file', async () => {
        ...
        expect(daoContent).toContain('export class UserDao extends BaseDaoDoubleID<User, InsertUser>');
    ...
    it('should generate model and dao file of two tables', async () => {
        ...
        expect(newsContent).toContain('export class NewsDao extends BaseDao<News, InsertNews>');
    ...
    it('should generate book dao with BaseDaoUUID', async () => {
        ...
        expect(daoContent).toContain('export class BookDao extends BaseDaoUUID<Book, InsertBook>');
        expect(daoContent).toContain("table_name: 'book'");
    });

    it('should generate files with header when writeHeader is true', async () => {
        const options: CliOptions = {
            writeHeader: true,
            generateType: 'all' as GenerateType,
            outputDir: TEST_OUTPUT_DIR,
        ...
        const modelContent = fs.readFileSync(modelFileUser, 'utf-8');
        expect(modelContent).toContain('AUTO-GENERATED FILE @');
        expect(modelContent).toContain('This file was automatically generated by mysql-plain-dao');

        // Check dao file header
        const daoContent = fs.readFileSync(daoFileUser, 'utf-8');
        expect(daoContent).toContain('AUTO-GENERATED FILE @');
        expect(daoContent).toContain('This file was automatically generated by mysql-plain-dao');
        expect(daoContent).toContain('Feel free to add your custom database access methods to this class');
    });

    it('should generate files without header when writeHeader is false', async () => {
        const options: CliOptions = {
            writeHeader: false,
            generateType: 'all' as GenerateType,
            outputDir: TEST_OUTPUT_DIR,
        ...
        // Check model file has no header
        const modelContent = fs.readFileSync(modelFileUser, 'utf-8');
        expect(modelContent).not.toContain('AUTO-GENERATED FILE @');
        expect(modelContent).not.toContain('This file was automatically generated by mysql-plain-dao');

        // Check dao file has no header
        const daoContent = fs.readFileSync(daoFileUser, 'utf-8');
        expect(daoContent).not.toContain('AUTO-GENERATED FILE @');
        expect(daoContent).not.toContain('This file was automatically generated by mysql-plain-dao');
        expect(daoContent).not.toContain('Feel free to add your custom database access methods to this class');

        // Verify the files still contain the necessary code
        expect(modelContent).toContain('export interface User');
        expect(daoContent).toContain('export class UserDao extends BaseDaoDoubleID<User, InsertUser>');
    });
});
